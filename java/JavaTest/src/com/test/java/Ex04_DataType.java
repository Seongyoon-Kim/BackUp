...
//		- 자바의 모든 정수형 상수는 int이다.(*************)
		...
		System.out.println(2100000);
		//System.out.println(21000000000000); // The literal 21000000000000 of type int is out of range 
		...
		//char m1 = ''; // 문자형은 ''안에 반드시 문자가 표현이 되어야 한다.
		String m2 = ""; // 빈 문자열(Empty String) -> 주로 문자열 변수를 초기화할 때 사용 or 그 외..
