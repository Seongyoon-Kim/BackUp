...
//		1 + 2 + 3 + 4
		...
		System.out.println(10.0 / 3.0);		// 3.333333333335
		System.out.println(10.0 / 3);		// 3.333333333335
		System.out.println(10 / 3.0);		// 3.333333333335
		
		System.out.println(a / (double)b);	// 3.333333333333
		System.out.println((double)a / b);	// 3.333333333333
		...
		System.out.println("잔액: " + ((long)money1 + money2)); // int + int = int > Overflow 발생
		System.out.println();
		System.out.println();
		System.out.println();
...
//		System.out.println(result);
		...
		String result = 19 <= age && age < 60 ? "성공" : "실패";
		
		
		System.out.printf("입력하신 나이 %d세는 회원 가입 %s입니다.", age, result);
