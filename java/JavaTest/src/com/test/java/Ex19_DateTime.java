...
public class Ex19_DateTime {
	...
	public static void main(String[] args) {
		...
		- 시각 + 시간 -> 2021.04.07 09:10 + 1시간 = 시각 (v) (add())
		- 시각 - 시간 -> 2021.04.07 09:10 - 1시간 = 시각 (v) (add())
	...
	private static void m5() {
		...
		birthday.set(1994, 6, 9, 15, 30, 50);
		...
		long christmassTick = christmas.getTimeInMillis();
		
		System.out.printf("올해 크리스마스는 %d일 남았습니다.\n", (christmassTick - nowTick) / 1000 / 60 / 60 / 24);
	...
	private static void m3() {
		...
		birthday.set(Calendar.MINUTE, 24);
		birthday.set(Calendar.SECOND, 30);
...
//		endDay.set(18, 0, 0);
	...
	private static void m2() {
		...
		//java.util.GregorianCalendar[time=1617756173999,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id="Asia/Seoul",offset=32400000,dstSavings=0,useDaylight=false,transitions=30,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2021,MONTH=3,WEEK_OF_YEAR=15,WEEK_OF_MONTH=2,DAY_OF_MONTH=7,DAY_OF_YEAR=97,DAY_OF_WEEK=4,DAY_OF_WEEK_IN_MONTH=1,AM_PM=0,HOUR=9,HOUR_OF_DAY=9,MINUTE=42,SECOND=53,MILLISECOND=999,ZONE_OFFSET=32400000,DST_OFFSET=0]
		...
		System.out.println("홍길동"); //? -> 사람이름인지 아닌지 정확하게 알 수 없다.
