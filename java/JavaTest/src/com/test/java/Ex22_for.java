...
//			}
	...
	private static void m5() {
		...
		//0이 없으면 null 상태(연산이나 행동의 대상이 될 수 없다.) -> 0과 다른 의미
		int sum = 0;
	...
	private static void m2() {
		...
		//지역 변수
		// - 메소드 내에서 선언한 변수 > 생명주기(영역) > 메소드를 영역으로..
		// - 제어문 내에서 선언한 변수 > 생명주기(영역) > 제어문을 영역으로..
...
//		System.out.println(result); // result cannot be resolved to a variable
	...
	private static void m1() {
		...
		//i -> 루프 변수, Loop Variable -> 회전을 제어하는 역할
		//초기식 -> int i = 1;
		//조건식 -> i <= 5;
		//증감식 -> i++;
