...
public class Ex55_Cast {
	...
	public static void main(String[] args) {
		...
		//Boxing(박싱)
		// - 기본형의 데이터를 Object 변수에 담을 때 발생하는 현상
		Object o11 = 100; //new Integer(100) 실행
...
//		System.out.println(t1 + t2);
		...
		//**** 모든 기본형의 데이터도 Object 변수에 넣을 수 있다.
		// -> Boxing 발생
		//*** Object 변수의 기본형 데이터를 (올바르게) 사용하려면 원래 기본형 타입으로 형변환을 해야한다.
		// -> UnBoxing 발생 // 비용 발생
