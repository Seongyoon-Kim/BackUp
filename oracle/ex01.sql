...
1. 계층형 DBMS
2. 망형 DBMS
3. 관계형 DBMS > 현재 > 데이터를 표 형태로 저장/관리
4. 객체지향형 DBMS
5. 객체관계형 DBMS
...
1. DDL
    ...
    - 데이터 정의어
    - 구조를 만드는 언어
    - 테이블, 뷰, 사용자, 인덱스 등의 객체(OB Object)를 생성, 수정, 삭제하는 명령어
    a. create: 생성
    b. drop: 삭제
    c. alter: 수정
    - 데이터베이스 관리자
...
select * from tabs; -- 수업은 소문자로.
SELECT * FROM tabs; -- 더 많이 사용한다.(알아보기 쉽기 때문)
