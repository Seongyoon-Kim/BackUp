...
select sysdate,
    ...
    to_char(sysdate, 'hh24:mi'),   --10, 시(24H) *****
...
SELECT
    *
FROM TBLINSA
    WHERE IBSADATE BETWEEN '2010-01-01' AND '2010-12-31'; -- 2020-01-01 00:00:00 ~ 2020-12-31 00:00:00
...
SELECT '14:23:45',
        TO_CHAR(TO_DATE('14:23:45', 'HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;