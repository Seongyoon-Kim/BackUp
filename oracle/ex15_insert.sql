...
--6. null 허용 컬럼 조작
insert into tblMemo (seq, name, memo) values (seqMemo.nextVal, '홍길동', '메모입니다.'); -- 암시적 방법(해당 컬럼 명시 X)
...
insert into tblMemo (seq, name, memo, regdate) values (seqMemo.nextVal, default, '메모입니다.', dafault);
...
insert into tblMemo values ('홍길동', '메모입니다.', seqMemo.nextVal, sysdate);
