...
데이터베이스 구축
- 프로젝트 진행 > 다량의 데이터 발생 > 저장하기 위한 조직화된 구조 생성 > 설계 > 구축
...
ex) 회사 정보 관리 프로젝트
    ...
    b. 부서 정보 관리 기능
        ...
        - 속성(부서명, 부서번호, 사무실 번호, 내선번호) -> 부서(엔티티)
...
ex) 회원 엔티티 > 회원번호(후보키, 기본키), 아이디(후보키, 대체키), 비밀번호, 주소 등
