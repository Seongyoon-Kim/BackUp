...
public class Ex04 {
	...
	public static void main(String[] args) throws IOException {
		...
		// 준비물
		// - 크롬 브라우저(92.0.4515.107(공식 빌드) (64비트))
		// - 엣지 브라우저
...
//		      body > section > div > button:nth-child(2)
		...
		WebElement btnWrite = driver
				.findElement(By.cssSelector("body > section > form > div > button.btn.btn-primary"));
		btnWrite.click();
	...
	private static void m3() {
		...
		String webDriverID = "D:\\webdriver\\chromedriver.exe";
		String path = "chromedriver.exe";
	...
	private static void m1() throws IOException {
		...
		// 아래 URL은 접속 불가능
		String url = "http://lms1.sist.co.kr/worknet/SMember/index.asp?strCode=I202103260005";
		// String selector = "#content > div > div > div > div.panel-body > form > table
		// > thead > tr:nth-child(5) > td:nth-child(2)";
		String selector = "td";
