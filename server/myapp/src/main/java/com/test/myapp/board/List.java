...
//		}
		...
		// 이전 10페이지
//		if (n == 1) {
//			pagebar += pagebar += String.format(" <a href='#!'>[이전 %d페이지]</a> ", blockSize);
//		} else {
//			pagebar += pagebar += String.format(" <a href='/myapp/board/list.do?page=%d'>[이전 %d페이지]</a> ", n-1, blockSize);
//		}
		...
		if (n == 1) {
			...
			pagebar += pagebar += String.format(
					" <li><a href='/myapp/board/list.do?page=%d' aria-label='Previous'> <span aria-hidden='true'>&laquo;</span></a></li> ",
					n - 1);
		}
...
//		}
		...
		// 다음 10페이지
//		if (n > totalPage) {
//			pagebar += String.format(" <a href='#!'>[다음 %d페이지]</a> ", n, blockSize);
//		} else {
...
//		}
		...
		if (n > totalPage) {
			...
			pagebar += String.format(
					" <li><a href='/myapp/board/list.do?page=%d' aria-label='Next'> <span aria-hidden='true'>&raquo;</span></a></li> ",
					n);
		}
