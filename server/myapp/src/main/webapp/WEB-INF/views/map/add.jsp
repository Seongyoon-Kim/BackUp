...
<body>
	...
	<section class="main-section">
		...
		<h1>Map API <small>Add 추가하기</small></h1>
		
		<div id="map" style="width:100%; height:400px;"></div>
		
		<hr>
		
		<form action="/myapp/map/addok.do" method="POST">
			<table class="table table-bordered">
				...
				<tr>
					<th>이름</th>
					<td><input type="text" name="name" id="" class="form-control" required="required" /></td>
				</tr>
			</table>
			
			<input type="submit" value="추가하기" class="btn btn-default" />
			<input type="button" value="돌아가기" class="btn btn-default" onclick="location.href='/myapp/map/map.do?no=ex04'" />
